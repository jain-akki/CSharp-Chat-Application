    ...
    public partial class Login : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            /*if (File.Exists("NetSet.txt"))
            {
                ...
                fs.Close();
                br.Close();
                //Instant Chat Connect to the Chat Database(*******Look at it later***********)
                TempClass.connectionString = ("workstation id=ChatDatabase.mssql.somee.com;packet size=4096;user id=ChatDatabase;pwd=akshay@7441;data source=ChatDatabase.mssql.somee.com;persist security info=False;initial catalog=ChatDatabase");
                //TempClass.connectionString=(@"Data Source=.\sqlexpress;Initial Catalog=Chat;Integrated Security=True");
            }
            else {
               // NetworkSetting serverAdd = new NetworkSetting();
                //serverAdd.Show();
            }*/
            TempClass.connectionString = ("workstation id=GossipsOnline.mssql.somee.com;packet size=4096;user id=akki1_SQLLogin_1;pwd=z8rp4x7bu6;data source=GossipsOnline.mssql.somee.com;persist security info=False;initial catalog=GossipsOnline");
            if (1==1)
            {
                try
                {
                    ...
                    if (i == 0)
                    {
                        MessageBox.Show("1: Provided information does not match. \nPlease Check Your Data");
                    }
                }
                catch (Exception ex)
                {
                    MessageBox.Show("2: Provided information does not match. \nPlease Check Your Data");
                }
            }
        }
